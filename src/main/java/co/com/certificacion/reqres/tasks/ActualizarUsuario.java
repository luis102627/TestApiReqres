...
public class ActualizarUsuario implements Task {
    ...
    public ActualizarUsuario(List<DatosUsuario> data) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Put.to(Constantes.ENDPOINT_UPDATE_AND_DELETE + id).with(req -> req
    ...
    public static ActualizarUsuario enApiReqres(List<DatosUsuario> data) {
        return instrumented(ActualizarUsuario.class, data);
    }
}
